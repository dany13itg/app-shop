...
@section('content')
   ...
   <div class="main main-raised">
      ...
      <button hrer="{{url ('/admin/products/create') }}" class="btn btn-primary btn-round">Nuevo Producto</button>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="td-actions text-right">
                <button type="button" rel="tooltip" title="Ver Productos" class="btn btn-info btn-simple btn-xs">
